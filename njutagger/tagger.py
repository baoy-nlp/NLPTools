"""
implement with Pytorch, which is support tensor operation and dynamic graph computing
"""
...
# optimizer=optimize.Adadelta(model.parameters())
optimizer = optimize.SGD(model.parameters(), lr=0.1)
